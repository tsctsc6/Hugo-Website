...
lastmod = '2025-12-05T13:06:37+08:00'
draft = false
title = 'HMAC 算法'
...
HMAC 不是一个哈希算法，而是一个用哈希函数构建的算法。相比哈希算法，输入多了一个密钥。
...
>
> - HMAC 算法也被称为“安全的哈希算法”。
> - 广义来说， HMAC 算法能用于[数字签名](../Message-Digest/index.md#数字签名)，但是签名和验证都使用同一个密钥（K），也就是只有持有该密钥的一方才能生成或校验签名。
